...
public class Athlete {
   ...
   */
  public int hashCode() {
    return Objects.hash(this.athletesName.getFirstName(), this.getAthletesName().getLastName());
  }
  ...
  public String toString() {
    return this.athletesName.getFirstName() + " " + this.athletesName.getLastName();
  }
}