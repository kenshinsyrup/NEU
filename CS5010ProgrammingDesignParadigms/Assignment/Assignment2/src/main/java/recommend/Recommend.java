...
import furniture.accessory.AbstractAccessory;
...
public class Recommend {
   ...
   * @return
   */
  public void recommend(Criteria criteria) {
  ...
  private JSONObject buildJSON(AbstractCabinet abstractCabinet, int cabinetNum,
    ...
    for (Mount mount : abstractCabinet.getMounts()) {
    ...
    for (Color color : abstractCabinet.getColors()) {
      colorJSONArr.add(color.getName());
    }
  ...
  private JSONObject getPartJSONObj(AbstractPart abstractPart) {
    ...
    JSONArray colorJSONArr = new JSONArray();
    for (Color color : abstractPart.getColors()) {
      colorJSONArr.add(color.getName());
    }
    partJSONObj.put("colors", colorJSONArr);

    if (abstractPart.getDoorAbstractHandle() != null) {
      partJSONObj.put("door_handle", getAccessoryJSONObj(abstractPart.getDoorAbstractHandle()));
    }
    if (abstractPart.getDrawerAbstractHandle() != null) {
      partJSONObj.put("drawer_handle", getAccessoryJSONObj(abstractPart.getDrawerAbstractHandle()));
    }
  ...
  private JSONObject getMountJSONObj(Mount mount) {
  ...
  private Set<AbstractCabinet> recommendCabinets(Criteria criteria) {
    ...
    while (iterator.hasNext()) {
      ...
      if (criteria.getColors() != null) {
        ...
        for (Color color : criteria.getColors()) {
