            ...
            try {
                ...
                // Otherwise, check if we can read in at least one new message
                    ...
                    while ((start + MIN_MESSAGE_LENGTH) <= charBuffer.limit()) {
                        ...
                        System.out.println("hasNext received msg in buffer: " + charBuffer.toString());
                        ...
                        // Recipient
                        String recipient = "";
                        if (handle.equals(MessageType.DIRECT_MESSAGE.toString()) || handle.equals(MessageType.SEND_INSULT.toString())) {
                        ...
                        Message newMsg = Message.makeMessage(handle, sender, recipient, "", null, message);
