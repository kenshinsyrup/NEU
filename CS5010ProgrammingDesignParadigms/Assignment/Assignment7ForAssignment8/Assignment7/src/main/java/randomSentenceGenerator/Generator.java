...
public class Generator {
  ...
  public String generateOneInsult() throws Exception{
    Grammar grammar = new Grammar();
    JSONReader jsonReader = new JSONReader(this.directoryPath);
    List<String> fileNameList = jsonReader.getFileNameList();
    int idx = 0;
    jsonReader.parseJSONFileToGrammar(fileNameList.get(idx), grammar);
    String sentence = grammar.buildSentence();
    return sentence;
  }
}
